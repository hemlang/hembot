...
TESTS   := tests/test_extract.hml tests/test_config.hml tests/test_strategy.hml tests/test_spinner.hml
...
$(BIN): $(SRC) src/extract.hml src/config.hml src/strategy.hml
	hemlockc $(SRC) -o $@
